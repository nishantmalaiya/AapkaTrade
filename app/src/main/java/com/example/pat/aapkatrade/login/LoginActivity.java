                ...
                if (Validation.isValidEmail(input_email)) {
                    ...
                    if (Validation.validateEdittext(password)) {
                        ...
                        if (appSharedpreference.shared_pref != null) {
                            ...
                            } else if (AndroidUtils.getUserType(appSharedpreference.getsharedpref("usertype", "0")).equals("2")) {
                            ...
                            } else if (AndroidUtils.getUserType(appSharedpreference.getsharedpref("usertype", "0")).equals("1")) {
